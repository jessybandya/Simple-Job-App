    ...
    <TableContainer sx={{ maxHeight: 440 }}>
      <Table stickyHeader aria-label="sticky table">
        <TableHead sx={{ display: "table-header-group" }}>
          ...
          <TableCell style={{minWidth:170,fontSize:13,backgroundColor: "#2a68af",fontWeight:"900",borderBottom: "2px solid #fff",color:"#fff"}} align="right">APPLICATION(s)</TableCell>
